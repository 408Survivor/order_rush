...
> 最后更新：2026-08-04（Session 12：#48 UI 翻新 + #50 布局动线/两段式补给合并；#51 场景美术待开工；下一步：开发者 F5 实测 → #51）
...
| #51 | [美术] 场景陈设升级：道具素材批量生成 + 店内重摆（对标杯杯倒满） | **下一个开工**（依赖 #50 坐标已就绪） |
...
| 📌 布局坐标（当前，#50 后） | 世界 (1920,1080)；冷库区左上（货箱堆 CRATE_SLOTS (150/320/490,200)）；冰柜 (1150,180)；微波炉 (1440,180)+(1700,180)；取包位 MEAL_SLOTS (1050/1150/1250,300)；柜台 (1350,520)、入口 (80,520)、外卖口 (1640,520)、玩家出生 (960,300)；餐桌 (450/800/1150/1500,800)。**单一权威 `layout_manager.gd`** |
