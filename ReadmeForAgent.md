...
> 最后更新：2026-08-04（Session 15：#54 合并后 F5 实测反馈"画面太拥挤"→ 已挂 issue #56；截图工具是开工前置；下一步：开发者授权/跑通截图 → #56 画面减负）
...
| #56 | [观感] 画面减负：陈设/UI 密度过高，先加截图工具再评估 | **下一个开工**（前置：调试截图能力） |
...
| 📌 布局坐标（当前，#54 后） | 世界 (1920,1080)；冷库区左上（货箱堆 CRATE_SLOTS (150/320/490,200)）；冰柜 (1150,180)；微波炉 (1440,180)+(1700,180)；柜台 (1350,520)、入口 (80,520)、外卖口 (1640,520)、玩家出生 (960,300)；餐桌 (450/800/1150/1500,800)。#54 起取包位 MEAL_SLOTS 已删——料理包经冰柜四格 J/K/L/空格 直接取货。**单一权威 `layout_manager.gd`** |
